...
//ABURA       return CTweetNacl.crypto_hash_sha512_tweet(hashPointer, messagePointer, UInt64(message.count))
...
//ABURA       return CTweetNacl.crypto_verify_32_tweet(xPointer, yPointer)
...
//ABURA       return CTweetNacl.crypto_scalarmult_curve25519_tweet_base(pkPointer, skPointer)
...
//ABURA       return CTweetNacl.crypto_sign_ed25519_tweet_keypair(pkPointer, skPointer)
...
//ABURA               return CTweetNacl.crypto_secretbox_xsalsa20poly1305_tweet(cPointer, mPointer, UInt64(m.count), noncePointer, keyPointer)
    ...
    public static func open(box: Data, nonce: Data, key: Data) throws -> Data {
        ...
        let result = m.withUnsafeMutableBytes { (mPointer: UnsafeMutablePointer<UInt8>) -> Int32 in
            return c.withUnsafeBytes({ (cPointer: UnsafePointer<UInt8>) -> Int32 in
                return nonce.withUnsafeBytes({ (noncePointer: UnsafePointer<UInt8>) -> Int32 in
                    return key.withUnsafeBytes({ (keyPointer: UnsafePointer<UInt8>) -> Int32 in
//ABUAR               return CTweetNacl.crypto_secretbox_xsalsa20poly1305_tweet_open(mPointer, cPointer, UInt64(c.count), noncePointer, keyPointer)
...
//ABURA           return CTweetNacl.crypto_scalarmult_curve25519_tweet(qPointer, nPointer, pPointer)
    ...
    public static func base(n: Data) throws -> Data {
        ...
        let result = q.withUnsafeMutableBytes { (qPointer: UnsafeMutablePointer<UInt8>) -> Int32 in
            return n.withUnsafeBytes({ (nPointer: UnsafePointer<UInt8>) -> Int32 in
//ABURA       return CTweetNacl.crypto_scalarmult_curve25519_tweet_base(qPointer, nPointer)
...
//ABURA           return CTweetNacl.crypto_box_curve25519xsalsa20poly1305_tweet_beforenm(kPointer, pkPointer, skPointer)
...
//ABURA           return CTweetNacl.crypto_sign_ed25519_tweet_open(tmpPointer, tmpLength, signMessagePointer, UInt64(signedMessage.count), publicKeyPointer)
    ...
    public static func signDetachedVerify(message: Data, sig: Data, publicKey: Data) throws -> Bool {
        ...
        let result = m.withUnsafeMutableBytes { (mPointer: UnsafeMutablePointer<UInt8>) -> Int32 in
            return sm.withUnsafeBytes({ (smPointer: UnsafePointer<UInt8>) -> Int32 in
                return publicKey.withUnsafeBytes({ (publicKeyPointer: UnsafePointer<UInt8>) -> Int32 in
//ABURA           return CTweetNacl.crypto_sign_ed25519_tweet_open(mPointer, tmpLength, smPointer, UInt64(sm.count), publicKeyPointer)
